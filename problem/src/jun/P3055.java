    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!queueMove.isEmpty()){
            if(moveSize == 0){
                ...
                for(int i = 0 ; i <wSize; i++){
                    ...
                    for(int j = 0 ;j<4;j++){
                        ...
                        if(newR <0 || newC <0 || newR >= row || newC >=col || matrix[newR][newC] == -2 || matrix[newR][newC] == -1 || (newR == endRow && newC == endCol))continue;
            ...
            for(int j = 0 ;j<4;j++){
                ...
                if(newR <0 || newC <0 || newR >= row || newC >=col || node.count >= matrix[newR][newC])continue;
