...
//                System.out.println("ret : "+ret.ID+","+ret.height+","+ret.used);
////
//                System.out.println("ans : "+ans+","+ans_height+","+ans_used);
    ...
    public static void main(String[] args) throws Exception {
        int T, MARK;
        System.setIn(new java.io.FileInputStream("res/sample_input (5).txt"));
